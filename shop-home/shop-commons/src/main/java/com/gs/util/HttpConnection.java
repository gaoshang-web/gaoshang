    ...
    * */
    ...
    public static String  getResult(HttpRequestBase target){
        ...
        try {
            ...
            e.printStackTrace();
            //服务器连接超时异常
            return JSON.toJSONString(ResponseServer.error(ResponseEnum.SERVER_CONNECT_ERROR));
        } catch (SocketTimeoutException e) {
            e.printStackTrace();
            return JSON.toJSONString(ResponseServer.error(ResponseEnum.SERVER_TIMEOUT));
        } catch (IOException e) {
            e.printStackTrace();
            return JSON.toJSONString(ResponseServer.error(ResponseEnum.SERVER_CONNECT_ERROR));
        }finally {
